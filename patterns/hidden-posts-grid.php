<?php
/**
 * Title: Posts grid with sidebar
 * Slug: daren/hidden-posts-grid
 * Description: The journal and most archives: cards two to a row, beside the sidebar.
 * Inserter: no
 *
 * @package Daren
 */
...
<div class="wp-block-column" style="flex-basis:67.5%"><!-- wp:query {"queryId":18,"query":{"perPage":6,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"className":"daren-cards daren-cards\u002d\u002dtwo","layout":{"type":"default"}} -->
<div class="wp-block-query daren-cards daren-cards--two"><!-- wp:post-template {"layout":{"type":"default"}} -->
