...
// A Playground logs every visitor in; the screenshot is what a visitor sees.
await page.addStyleTag( { content: '#wpadminbar{display:none!important}html{margin-top:0!important;--wp-admin--admin-bar--height:0px!important}' } );
